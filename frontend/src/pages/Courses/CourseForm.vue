			...
			>
				<div class="my-5">
					...
					<div class="pe-5 md:pe-10 pb-5 mb-5 space-y-5 border-b">
						...
						<FormControl
							v-model="courseResource.doc.calendly_link"
							:label="__('Booking Link (Calendly)')"
							:description="
								__(
									'Link shown on locked chapters. Students click this to book a call and request chapter access.'
								)
							"
							@input="makeFormDirty()"
						/>
